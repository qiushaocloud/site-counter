...
# 头像默认图片地址, 配置了后，加载头像失败或者加载的是官方默认头像时，使用该图片作为头像，您可以配置成动态头像地址，如：https://api.7585.net.cn/sjtx/api.php?lx=c1 或 https://api.uomg.com/api/rand.avatar?sort=动漫女&format=images
